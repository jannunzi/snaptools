...
function TrebleClef() {
  return (
    <g transform="translate(36 22) scale(1.55)" aria-hidden>
      <path
        d="M16.4 47.8c.2-1.6.3-3.2.3-4.8 0-5.8-2-10-5.3-13.3 1.6-7.1 3.1-14.2 3.1-17.8 0-6.2-2.4-9.6-5.9-9.6-3 0-5.3 2.4-5.3 5.8 0 2 .8 4 2 5.6-1.4 5.6-3 11.4-4.8 15.7C2.2 32.5.2 37.1.2 41.9c0 7.6 6 12.9 14 12.9 1.2 0 2.4-.2 3.4-.5-1.2 5-2.8 9.8-4.8 13.9-3.2 6.6-6.8 11.2-11 11.2-1.6 0-2.8-1-2.8-2.6 0-1.8 1.2-3.4 2.2-5 1.4-2.2 2.8-4.6 2.8-7.4 0-3.2-2-5.2-4.8-5.2-3.4 0-5.8 3-5.8 7.4 0 7.8 6.6 14 14.8 14 9.8 0 17.6-7.6 22-18.2 2-4.8 3.6-10 5-15.3 3.8-.6 6.6-3.8 6.6-7.8 0-4.2-3.2-7.4-7.4-7.4-2.8 0-5.2 1.4-6.6 3.6zM13.9 13.8c1.4 0 2.2 1.4 2.2 3.6 0 2.4-1 7.6-2.4 13.8-2.4-3-3.8-6.6-3.8-10.6 0-4.2 1.8-6.8 4-6.8zM5.3 48.8c2.8-5.6 5.2-12.4 6.8-18.8 2.6 2.8 4.2 6.2 4.2 10.2 0 2.8-.8 5.2-2.2 7.4-2.2 3.4-5.6 5.6-9.6 6.6.2-1.8.4-3.4.8-5.4z"
        fill="currentColor"
      />
    </g>
  );
