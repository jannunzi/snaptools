  ...
  return (
    <article className="mx-auto w-full max-w-5xl px-4 py-8 sm:px-6 sm:py-10">
      <p className="no-print text-xs font-semibold uppercase tracking-wider text-accent">
        Day {tool.day} · {tool.status === "live" ? "Live" : "Coming soon"}
      </p>
      ...
      <div className="no-print mt-5 rounded-xl border border-line bg-accent-soft/60 px-4 py-3 text-sm leading-relaxed text-ink">
